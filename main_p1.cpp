...
blst_p1_affine pippenger_variant_CHES_primitive_implementation(){
...
/* Correctess verified*/
blst_p1_affine pippenger_variant_q_over_5_CHES_prefetch_1step_ahead(){
...
/* Correctess verified*/
blst_p1_affine pippenger_variant_q_over_5_CHES_prefetch_2step_ahead(){
...
blst_p1_affine pippenger_variant_q_over_5_CHES_3nh(){
...
blst_p1_affine pippenger_variant_q_over_5_CHES_noindexhash(){
...
blst_p1_affine pippenger_variant_BGMW95(){
...
blst_p1_affine pippenger_blst_built_in(){
...
void test_pippengers(){
    std::cout << "PIPPENGERS TEST OVER G1 for NPOINTS:  2**" << N_EXP << std::endl;
